...
def load_hdf5_data(h5_file,frame):
   ...
   # Load data and plot with vertical lines at peak positions
    ...
    title = f'Scipy peak picking (prominence={prominence:.2f})'
    plot_function_peak_positions(data, peaks, title)
